...
# About this project
*section left blank for coding agent to eventually use. The following headers are suggestions for the outline of the description, but I am open to suggestions or better solutions based on best practices and the outcomes of the project.*
## Goal
...
# Updates
**05/26/2026 15:51** - Uploaded new project manifest for AI prompting.
